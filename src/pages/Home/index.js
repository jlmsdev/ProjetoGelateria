...
import pessoasSorvete from "../../assets/sobre-image.jpg";
  ...
  return (
    <>
      <section className="bannerHome">
        ...
        <figure className="containerImage">
          <img
            className="imgHome"
            src={bannerHome}
            alt="Imagem de Sorvete na Home Page"
          />
      ...
      <main className="containerInfo">
        ...
        <section className="textoInstitucional">
          ...
          <p>
            ...
            magnam perferendis ad error repudiandae non sapiente! Ducimus, odio
            id architecto sint incidunt qui accusamus amet quae officia ipsum
            expedita. Minus animi, tempore aut velit consectetur veritatis quo
            labore distinctio consequatur cupiditate iste quasi amet accusantium
            libero qui magni hic sit exercitationem fuga, nihil quos praesentium
            impedit! Nobis, ab voluptatum?
          </p>
      ...
      <section className="containerEventos">
        ...
        <section className="infoEventos">
          ...
          <p>
            ...
            magnam perferendis ad error repudiandae non sapiente! Ducimus, odio
            id architecto sint incidunt qui accusamus amet quae officia ipsum
            expedita. Minus animi, tempore aut velit
          </p>
      ...
      <section className="containerEventos">
        ...
        <figure className="imageEvento">
          <img src={pessoasSorvete} alt="Banner Eventos" />
        </figure>
